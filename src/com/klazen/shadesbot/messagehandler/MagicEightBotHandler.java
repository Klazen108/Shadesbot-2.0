...
public class MagicEightBotHandler extends SimpleMessageHandler {
	...
	protected boolean onMessage(String username, boolean isMod, boolean cooldownReady, String message, Matcher m, MessageSender sender) {
		...
		case 10: sender.sendMessage(username + ", Reply hazy, try again. ༼ つ ⌐■_■ ༽つ", false); break;
		case 11: sender.sendMessage(username + ", Ask again later. ༼ つ ⌐■_■ ༽つ", false); break;
		case 12: sender.sendMessage(username + ", Better not tell you now. ༼ つ ⌐■_■ ༽つ", false); break;
		case 13: sender.sendMessage(username + ", Cannot predict now. ༼ つ ⌐■_■ ༽つ", false); break;
		case 14: sender.sendMessage(username + ",  Concentrate and ask again. ༼ つ ⌐■_■ ༽つ", false); break;
